 ...
 */
class getSoftwareRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SoftwareRepository' shared autowired service.
     *
     * @return \App\Repository\SoftwareRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SoftwareRepository.php';

        return $container->privates['App\\Repository\\SoftwareRepository'] = new \App\Repository\SoftwareRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
