...
class getJmsSerializer_ExpressionEvaluatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'willdurand'.\DIRECTORY_SEPARATOR.'hateoas-bundle'.\DIRECTORY_SEPARATOR.'Expression'.\DIRECTORY_SEPARATOR.'LinkExpressionFunction.php';
